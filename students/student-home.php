...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <div class="logo"><a href="http://gcettb.ac.in/" target="blank">GCETTB T&P Cell</a></div>
            <div class = "logout">   
    ...
    <div class="title"><h1><?php echo "Welcome " . strtok($_SESSION['username'], " ") . " to the Dashboard"; ?></h1></div>
                ...
                <div class="container col-12 services-container">
                    <div class="col-md-4">
                        <div class="service-box text-center color3">
                            ...
                            <a href="insert.php" class="text-decoration-none"><button class="button"><h3 class="mb-1 mt-0">Insert Data</h3></button></a>
                        </div>
                    </div>
